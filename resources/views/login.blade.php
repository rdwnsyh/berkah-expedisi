...
<head>
  ...
  <title>Pages / Login - Berkah Expedisi</title>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">masukan username & email untuk login</p>
                  </div>

                  <form class="row g-3 needs-validation" action="/admin/login" method="POST">
                    @csrf
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="login" class="form-control @error('login') is-invalid @enderror" 
                               id="login" required value="{{ old('login') }}" 
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" 
                             id="yourPassword" required placeholder="Masukkan password">
                      @error('password')
                      <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
