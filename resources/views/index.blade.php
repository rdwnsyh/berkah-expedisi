...
@section('content')
  ...
  <section id="hero" class="hero section dark-background">
    <div id="hero-carousel" data-bs-interval="5000" class="container-fluid carousel carousel-fade" data-bs-ride="carousel">
      <!-- Slide 1 -->
      <div class="carousel-item active" style="background: url('images/truk.jpeg') no-repeat center center/cover">
      ...
      <!-- Slide 2 -->
      <div class="carousel-item" style="background: url('images/truk2.jpeg') no-repeat center center/cover">
        <div class="carousel-container">
      ...
      <!-- Slide 3 -->
      <div class="carousel-item" style="background: url('images/truk3.jpeg') no-repeat center center/cover">
        <div class="carousel-container">
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">  
            <div class="service-item position-relative">
              <div class="icon">
                <i class="bi bi-calendar4-wee k" style="color: #fd7e14;"></i>
              </div>
              <a href="service-details.html" class="stretched-link">
                <h3>Eosle Commodi</h3>
              </a>
